...
if ($_POST) {
  ...
  $tambah_admin = "INSERT INTO admin (id, nama, username, password, waktu_registrasi) VALUES (null, '$nama', '$username', '$password', '$waktu_registrasi')";
}
...
<body>
  ...
  <main class="container mb-5">
    <?php if ($_POST) : ?>
      <?php if (mysqli_query($koneksi, $tambah_admin)) : ?>
        <div class="alert alert-success">
          Tambah Admin Baru Berhasil!
        </div>
      <?php else : ?>
        <div class="alert alert-warning">
          Tambah Admin Baru Gagal! Kesalahan: <?= mysqli_errno($koneksi); ?>
        </div>
      <?php endif; ?>
    <?php endif; ?>
    <form method="POST">
      ...
      <button class="btn btn-primary ms-3">Tambah Admin</button>
    </form>
  </main>
